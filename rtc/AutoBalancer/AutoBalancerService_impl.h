...
public:
  ...
  // CORBA::Boolean setStabilizerParam(const OpenHRP::AutoBalancerService::StabilizerParam& i_param);
  // CORBA::Boolean getStabilizerParam(OpenHRP::AutoBalancerService::StabilizerParam_out i_param);
